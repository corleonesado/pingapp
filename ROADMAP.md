...
- [ ] Install ArgoCD on minikube + apply Application (after first image is in GHCR)
- [ ] Verify: change to chart on `main` → ArgoCD auto-syncs a rollout
...
### Day 3 checkpoint
- [ ] Open a test PR → CI green end-to-end (needs push to GitHub)
- [ ] Image visible at `ghcr.io/corleonesado/pingapp` (after first main merge / release)
- [ ] `v0.1.0` GitHub Release exists with notes
- [ ] Merge/chart change triggers an ArgoCD sync in minikube
- [x] gitleaks + Trivy gates verified locally (green)
